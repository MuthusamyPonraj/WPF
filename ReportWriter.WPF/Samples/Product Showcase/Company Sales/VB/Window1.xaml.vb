...
#Region "Events"
    ...
    Private Sub Button_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs)
        Try
            Dim reportPath As String = "../../../../../../../../Common/Data/ReportTemplate/RDLC/Company Sales.rdlc"

            'Step 1: create the report data source.
            Dim dataSources As New ReportDataSourceCollection()
            dataSources.Add(New ReportDataSource() With {.Name = "Sales", .Value = New CompanySales.AdventureWorks().GetData()})

            'Step 2 : Instantiate the report writer (PdfWriter) with the parameter "ReportPath" and ReportDataSource Collection.
            Dim engine As New PdfWriter(reportPath, dataSources)

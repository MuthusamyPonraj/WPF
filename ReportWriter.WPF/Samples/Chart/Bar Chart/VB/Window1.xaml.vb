...
Namespace BarChart
	...
	Partial Public Class Window1
        ...
        Private Sub Button_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            Try
                Dim reportPath As String = "..\..\..\..\..\..\..\..\Common\Data\ReportTemplate\BarCharts.rdl"
                ...
                If pdf.IsChecked = True Then
                    fileName = "BarCharts.pdf"
                    format = WriterFormat.PDF
                ElseIf word.IsChecked = True Then
                    fileName = "BarCharts.doc"
                    format = WriterFormat.Word
                ElseIf excel.IsChecked = True Then
                    fileName = "BarCharts.xls"
                    format = WriterFormat.Excel
                Else
                    fileName = "BarCharts.html"

        ...
        public class CountrySalesList : ObservableCollection<CountrySale>
        {
            public CountrySalesList()
            {
               ...
               // this.Add(new CountrySale() { Name = "Canada", Sales = 43523, Expense = 43523 });
                ...
                //this[0].RegionalSales.Add(new RegionSale() { Name = "San Fransico", Revenue = 8456, Expenditure = 8456 });
                //this[0].RegionalSales[0].RegionalSales.Add(new RegionSale() { Name = "San Fransico", Revenue = 8456, Expenditure = 8456 });

...
namespace NestedGridCellEditorsDemo.DataModel
{
    ...
    partial void OnPictureChanged();
		...
		[Association(Name="Categories_Products", Storage="_Products", ThisKey="CategoryID", OtherKey="CategoryID")]
    ...
    partial void OnFaxChanged();
		...
		[Association(Name="Customers_Orders", Storage="_Orders", ThisKey="CustomerID", OtherKey="CustomerID")]
    ...
    partial void OnReportsToChanged();
		...
		[Association(Name="Employees_Orders", Storage="_Orders", ThisKey="EmployeeID", OtherKey="EmployeeID")]
		public EntitySet<Orders> Orders
		{
			get
			{
    ...
    partial void OnDiscountChanged();
		...
		[Association(Name="Orders_OrderDetails", Storage="_Orders", ThisKey="OrderID", OtherKey="OrderID", IsForeignKey=true, DeleteOnNull=true)]
    ...
    partial void OnFreightChanged();
		...
		[Association(Name="Orders_OrderDetails", Storage="_OrderDetails", ThisKey="OrderID", OtherKey="OrderID")]
		...
		[Association(Name="Shippers_Orders", Storage="_Shippers", ThisKey="ShipVia", OtherKey="ShipperID", IsForeignKey=true)]
    ...
    partial void OnDiscontinuedChanged();
		...
		[Association(Name="Products_OrderDetails", Storage="_OrderDetails", ThisKey="ProductID", OtherKey="ProductID")]
		public EntitySet<OrderDetails> OrderDetails
		{
			get
			{
    ...
    partial void OnCompanyNameChanged();
		...
		[Association(Name="Shippers_Orders", Storage="_Orders", ThisKey="ShipperID", OtherKey="ShipVia")]
		public EntitySet<Orders> Orders
		{
			get
			{
    ...
    partial void OnFaxChanged();
		...
		[Association(Name="Suppliers_Products", Storage="_Products", ThisKey="SupplierID", OtherKey="SupplierID")]
		public EntitySet<Products> Products
		{
			get
			{

...
{
    /// <summary>
    /// Code for Exporting selected ranges to the Excel.
    /// </summary>
    public class ExportSelectedCommand
    {
        ...
        {
            //Registering the ExportSelectedToExcel command.
        ...
        {
            var grid = args.Source as GridDataControl;

            //Export Selected Ranges button is only enabled when the selected range is not empty.
            if (grid.Model.SelectedRanges.ActiveRange.IsEmpty)

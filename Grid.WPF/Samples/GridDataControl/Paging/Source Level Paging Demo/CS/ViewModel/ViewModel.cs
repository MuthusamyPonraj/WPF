...
namespace SourceLevelPaging
{
    class ViewModel
    {
        ...
        public ViewModel()
        {
            ...
            OrderDetails = new PagedCollectionView(this.GetOrders(250));
        }

        private ObservableCollection<OrderInfo> orders;

        private PagedCollectionView _OrderDetails;

        /// <summary>
        /// Gets or sets the order details.
        /// </summary>
        /// <value>The order details.</value>
        public PagedCollectionView OrderDetails
        {
            get
            {
        ...
        /// <returns></returns>
        public ObservableCollection<OrderInfo> GetOrders(int count)
        {
            SetShipCity();
        ...
        private OrderInfo GetOrder(int i)
        {
            ...
            return new OrderInfo()
            {
                ...
                IsClosed = r.Next(this.orders.Count) % 2 == 0,
            };
        }

...
{
    /// <summary>
    /// Interaction logic for ViewModel class
    /// </summary>
    ...
    { 
        ...
        public GridViewModel()
        {
            ...
            this.PersonDetails = this.CreateGenericPersonData(5, 4);
        ...
        /// <summary>
        /// Columns the chooser command handler.
        /// </summary>
        ...
        public GridViewModel(int count, int maxGenerations)
        {

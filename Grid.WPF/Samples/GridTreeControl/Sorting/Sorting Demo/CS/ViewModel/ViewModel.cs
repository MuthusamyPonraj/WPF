...
namespace GridTreeSorting
{
    public class ViewModel : NotificationObject
    {
        ...
        private bool _EnableTriStateSorting;

        public bool EnableTriStateSorting
        {
            get { return _EnableTriStateSorting; }
            set
            {
                _EnableTriStateSorting = value;
                RaisePropertyChanged("EnableTriStateSorting");
            }
        }

        private bool _EnableMultiColumnSorting;
        ...
        public bool EnableMultiColumnSorting
        {
            ...
            set
            {
                _EnableMultiColumnSorting = value;
                RaisePropertyChanged("EnableMultiColumnSorting");
            }
        }

        private object _SortOption;

        public object SortingOption
        {
            get { return _SortOption; }
            set
            {
                _SortOption = value;
                RaisePropertyChanged("SortingOption");
            }
        }

        private object _SortAction;

        public object SortAction
        {
            get { return _SortAction; }
            set
            {
                _SortAction = value;
                RaisePropertyChanged("SortAction");
            }
        }

        private object _UpdateMode;
